...
const danceData: Record<string, {
  ...
  "gumboots": {
    ...
    image: gumbootsImg,
    history: "Gumboot dance originated in the late 19th century in the gold mines of South Africa, particularly around the Witwatersrand region near Johannesburg. Migrant workers from countries such as Lesotho, Malawi, Zambia, Botswana, and Swaziland came to work in mines where conditions were extremely harsh — tunnels were often flooded with water, forcing miners to wear rubber boots. Mine bosses imposed strict rules, including banning workers from talking to each other while underground. As a result, miners developed a system of rhythmic tapping and slapping their gumboots to communicate messages to one another. These coded rhythms eventually evolved into what is now known as gumboot dancing.",
    significance: "During the apartheid era, Black miners lived in segregated compounds and experienced harsh working conditions and limited freedom. Gumboot dancing became more than communication — it became a form of expression and resistance. Miners used dance movements and rhythms to share stories, express frustration about working conditions, mock mine bosses, and strengthen solidarity among workers. The miners came from many different African ethnic groups including Zulu, Xhosa, Sotho, and Bhaca communities, making gumboot dance a fusion of various African cultural traditions. In Mangaung, the dance represents the resilience and creativity of South Africa's working-class communities and is performed at cultural festivals, school events, and heritage celebrations. Today it is recognized as one of the most iconic traditional dances in South Africa and is performed internationally.",
    artistic: "Gumboot dance is characterised by rhythmic stamping, slapping of Wellington boots, and percussive body movements. Instead of musical instruments, dancers create sound using their bodies and boots — stomping boots on the ground, slapping boots with hands, clapping, chest slaps, and vocal chants create a percussive musical performance similar to drumming. Many movements imitate mining activities, supervisors' behaviour, and daily life in the mines.",
    music: "The boots themselves serve as the primary instrument, supplemented by clapping, chest slaps, vocal chants, and sometimes guitar or concertina accompaniment.",
    costumes: "Wellington rubber boots (gumboots) are the most important costume element. Other features include bells attached to boots for extra sound, overalls or work clothes, traditional beadwork, and decorative accessories.",
    choreography: "Highly synchronised group formations with intricate stamping patterns, rapid foot tapping, jumping and sliding steps, knee lifts, boot-slapping sequences, and competitive freestyle sections symbolising teamwork among miners.",
  ...
  "pharatlhatlha": {
    ...
    history: "Setapa is one of the traditional dances that originate from the Tswana people of southern Africa, specifically from the Bangwaketse tribe of Botswana. The Bangwaketse are one of the eight principal tribes in Botswana, and are ethnic Tswana with their capital village in Kanye, located in the Southern District. The name Setapa comes from the Setswana phrase 'go tapa tapa' describing the tapping motion of the feet during the dance. Although widely performed across Tswana-speaking tribes today, this dance style used to only be seen during the harvest season (lethafula), typically in the month of April, with all-night performances out in the fields as well as at the village kgotla — the central administrative hub and meeting place in Tswana villages.",
    significance: "In Mangaung, a district combining both Sesotho and Batswana people, the Batswana introduced Setapa at after-school children's clubs, teaching children the dance and entering competitions with other clubs from different locations. They would also perform at weddings and festivals to bring joy to people and raise funds for their clubs. Setapa Dance Cultural Festivals are held to promote the understanding and appreciation of cultural heritage, while at the same time creating a leisurely experience for locals and internationals. The festivities usually continue into the night, dancing around a big fire. During performances, traditionally girls would sing, clap hands and ululate, whilst the boys would do most of the dancing with plenty of whistling to express joy. Today, both men and women engage in Setapa performances.",
    artistic: "Setapa music dance exists in three different types: Setapa sa dipitse (producing the sound of a galloping horse on the ground), Setapa sa phathisi (performed with the lower trouser leg tied with a peg or using short pants made of animal skin, adopted from the Bakwena tribe dance known as Phathisi), and Setapa sa go goga maoto (performed by dragging feet on the ground, adopted from the Basarwa dance called tsutsube). The dance is a celebratory form that originates from the Bangwaketse of South-East Botswana, marking community ceremonies such as good harvest and welcoming returning hunters or warriors.",
    music: "Hand clapping, vocal calls, ululation, whistling, traditional percussion, and strong rhythmic chanting support the pace and energy of the dance.",
    costumes: "Traditional Setswana-inspired attire, patterned garments, skirts, animal-skin shorts (for Setapa sa phathisi), blankets, beadwork, and accessories that emphasise movement and cultural identity.",
